...
# proxy = 'lum-customer-hl_e5a0e1f6-zone-usa_instagram-ip-38.145.108.214:7j6kam84o78a@zproxy.lum-superproxy.io:22225'
# proxy_chrome_extension = create_proxy_extension(proxy)

# login credentials
insta_username = 'dslr.lover.nepal'
insta_password = 'kubhwifi'
...
while True:
    with smart_run(session):
        ...
        competitors = ['trishala__official']
        ...
        session.interact_user_followers(my_competitors, amount=500, randomize=True)
